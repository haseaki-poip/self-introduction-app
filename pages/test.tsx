    ...
    <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
      ...
      >
        <div className="lg:w-8/12 p-4 md:p-12 text-center lg:text-left">
          ...
          <h1 className="text-3xl font-bold pt-8 lg:pt-0">Charlotte</h1>
          ...
          <p className="pt-4 text-gray-600 text-base lg:text-xl flex items-center justify-center lg:justify-start">
            <svg
              ...
              viewBox="0 0 512 512"
              className="h-5 fill-current text-green-700 pr-4"
            >
              <g>
                <path
                  className="st0"
          ...
          <p className="pt-4 text-base lg:text-xl flex items-center justify-center lg:justify-start">
            ...
            >
              <g>
                <path
                  className="st0"
                  d="M494.951,81.411c-8.782-19.97-22.202-37.857-40.19-52.147l-7.81,9.818l7.806-9.818
...
function rgb(
  ...
  arg1: number,
  arg2: number
): import("csstype").Property.Fill | undefined {
